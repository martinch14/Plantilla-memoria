...
\juradoUNO{Alejandro Permingeat (Fasta)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur1name
...
El marco general en el cual se desarrolló este proyecto fue la fundación y los primeros años de la empresa TECSCI S.A.S, el equipo que surge de este proyecto será comercializado en el transcurso del año 2022.
Cabe destacar que la empresa adhiere a los principios de \textit{software y hardware libre} por lo tanto todo el material relacionado estará disponible.


\textcolor{red}{Se tuvieron en cuenta para la realización del trabajo conceptos incorporados en las diferentes materias de la carrera de especializacion en sistemas embebidos tales como la implemetación de sistemas operativos de tiempo real, técnicas de testeo de software y técnicas de diseños de circuitos impresos entre otras.}

\textcolor{red}{El resumen debe escribirse en uno o dos párrafo.  Debe ser breve y conciso sin ningún elemento de formato en el texto como itálicas o negrita. Tampoco se deben usar siglas ni acrónimos que no resulten obvios para un lector promedio de la memoria, ni referencias bibliográficas o notas al pie de página.  No debe faltar qué es lo que se hizo/logró, qué importancia/valor tiene el proyecto/resultado, qué va a encontrar el lector en la memoria y qué contenidos de la especialización/maestría se aplicaron en el proyecto.}
