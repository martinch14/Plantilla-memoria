...
Como ejemplo de los resultados que se obtienen aplicando está técnica podemos observar en la figura \ref{fig:muestras} films de dioxido de titanio \ce{TiO2}, en la primer imagen el film se preparó sobre un wafer de silicio y en la segunda sobre un portaobjeto de vidrio.
