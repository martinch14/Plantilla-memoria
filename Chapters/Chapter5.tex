...
\item Investigadores del INS (Instituto de Nanosistemas) llevarán a cabo ensayos para caracterizar películas delgadas fabricadas por el equipo. El ensayo contemplará la generación de cincuenta muestras de \ce{TiO2} y \ce{SiO2} caracterizadas a través del método XRR (reflectometría de rayos-X). Surgirá de este ensayo un documento técnico que se enviará a publicar a una revista científica especializada.  
...
\footnotetext{Imagen brindada por equipo de diseño industrial.}
\end{itemize}
